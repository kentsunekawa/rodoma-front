...
const AppTheme = {
  light: {
    ...
    border: 'none',
    fadeOut: 'linear-gradient(to bottom, rgba(255,255,255,1) 0%,rgba(255,255,255,1) 18%,rgba(255,255,255,0) 100%)',
  },
  dark: {
    ...BaseTheme,
    bg: '#111', 
    ...
    fadeOut: 'linear-gradient(to bottom, rgba(17,17,17,1) 0%,rgba(17,17,17,1) 50%,rgba(17,17,17,0) 100%)',
  }
};
