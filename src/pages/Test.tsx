...
const Test: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <TabChanger selected={0}>
        <Tab>
          <Tabs tabList={["Following", "Followers"]} tabType={"switcher"} />
        </Tab>
        <TabContents>
          <TabContent>
            <div>Following</div>
      ...
      <TabChanger selected={0}>
        <Tab>
          <Tabs
            tabList={[<IconAdd />, <IconFollow />, <IconLike />, <IconMark />]}
            tabType={"rounded"}
          />
        </Tab>
        <TabContents>
    ...
    /> */}
      ...
      <Paragraph types={["title", "center"]}>ロードマップ</Paragraph>
      <Paragraph>これはキャプションです</Paragraph>
      <Paragraph>
        テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト
      </Paragraph>
      <Paragraph types={["caption", "primary"]}>
        これはキャプションです
      </Paragraph>

      <StatusCounter StatusType="like" num={30} />
      <StatusCounter StatusType="mark" num={56} />
    ...
    /> */}
      ...
      <ToggleTag value="userName" icon={<IconClose />} />

      <Tag value="Category" types={["gradient"]} />
      ...
      <TextButton types={["primary"]}>ユーザーを削除する</TextButton>
      <TextButton types={["withIconRight"]} icon={<IconRight />}>
        プロフィール
      </TextButton>
      ...
      <RoundButton onClick={outputLog}>終了する</RoundButton>

      <RoundButton onClick={outputLog} types={["l", "gradient"]}>
        Signin
      </RoundButton>
      ...
      <CircleButton onClick={outputLog}>
        <IconFollow />
      </CircleButton>

      <CircleButton types={["l", "gradient"]} onClick={outputLog}>
        <IconFollow />
      </CircleButton>
      ...
      <CircleButton types={["gray_midium"]} onClick={outputLog}>
        <IconWidthFixed />
      </CircleButton>
      ...
      <CircleButton types={["s", "gray_light"]} onClick={outputLog}>
        <IconFollow />
      </CircleButton>

      <CircleButton types={["xs", "gray_dark"]} onClick={outputLog}>
        <IconEdit />
      </CircleButton>
      ...
      <CircleButton types={["xs"]} onClick={outputLog}>
        <IconClose />
      </CircleButton>
