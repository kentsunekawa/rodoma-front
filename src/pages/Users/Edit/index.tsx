...
import { IconEdit, IconBan, IconChecked, IconCheck } from 'components/elements/icons';
...
const Component: React.FC<Props> = props => (
  <div className={`${CLASSNAME} ${props.className}`}>
    <PageBase>
      ...
      {
        props.userData && <div className='main'>
          <div className='iconArea'>
            <div className='icon'>
              <ImgUploader
                className='iconChangeButton'
                id='userIcon'
                onUpload={props.iconChange}
              >
          ...
          <div className='row'>
            {
              ...
              ? <div className='caption'><IconBan />このメールアドレスは未認証です</div>
              : <div className='caption -verified'><IconChecked />このメールアドレスは認証済です</div>
            }
